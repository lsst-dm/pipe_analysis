...
from .plotUtils import AllLabeller, OverlapsStarGalaxyLabeller, labelCamera, setPtSize
        ...
        if geFound:
            for ff in catalog.keys():
                if ff in galacticExtinction[fieldName]:
                    ...
                    catalog[ff] = addIntOrFloatColumn(catalog[ff], [galacticExtinction[fieldName][ff], ],
