...
class Analysis(object):
    ...
    def plotAll(self, dataId, filenamer, log, enforcer=None, butler=None, camera=None, ccdList=None,
        ...
        if "all" in self.data:
            self.plotSkyPosition(filenamer(dataId, description=self.shortName, style="sky-all" + postFix),
                                 ...
                                 forcedStr=forcedStr, dataName="all")
        ...
        if "star" in self.data:
            self.plotSkyPosition(filenamer(dataId, description=self.shortName, style="sky-stars" + postFix),
                                 ...
                                 tractInfo=tractInfo, patchList=patchList, hscRun=hscRun,
                                 matchRadius=matchRadius, zpLabel=zpLabel, highlightList=highlightList,
                                 forcedStr=forcedStr, dataName="star")
